...
export default function AdminContactPage() {
  ...
  const fetchSettings = async () => {
    try {
      ...
      if (editor) {
        editor.commands.setContent(data.contactContent || '');
      }
    } catch (error) {
    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-0">
      <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-zinc-500 font-medium">
            Customize the content displayed on the public contact page
          </p>
        </div>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-2xl border border-zinc-200 p-6">
          <label className="block text-[12px] font-black text-zinc-800 mb-3 ml-1 uppercase tracking-wider">Contact Title</label>
          <input
            type="text"
            value={contactTitle}
